...
set(FIPS_EMSCRIPTEN_SDK_VERSION "1.38.29")
...
option(FIPS_EMSCRIPTEN_USE_ASSERTIONS "emscripten: enable common memory runtime checks" OFF)
option(FIPS_EMSCRIPTEN_USE_SOURCE_MAPPING "emscripten: create source code mapping" OFF)
option(FIPS_EMSCRIPTEN_CHECK_STACK_OVERFLOW "emscripten: enable stack guard checks" OFF)
...
option(FIPS_EMSCRIPTEN_USE_PTHREADS "emscripten: use pthread (experimental)" OFF)
option(FIPS_EMSCRIPTEN_EXIT_RUNTIME "emscripten: shutdown runtime at exit" OFF)
...
if (FIPS_EMSCRIPTEN_EXIT_RUNTIME)
    set(EMSC_LINKER_FLAGS "${EMSC_LINKER_FLAGS} -s EXIT_RUNTIME=1")
else()
...
if (FIPS_EMSCRIPTEN_USE_SAFE_HEAP)
    ...
    set(EMSC_LINKER_FLAGS "${EMSC_LINKER_FLAGS} -s ALIASING_FUNCTION_POINTERS=0")
endif()
if (FIPS_EMSCRIPTEN_USE_ASSERTIONS)
    set(EMSC_LINKER_FLAGS_DEBUG "${EMSC_LINKER_FLAGS_DEBUG} -s ASSERTIONS=2")
endif()
if (FIPS_EMSCRIPTEN_CHECK_STACK_OVERFLOW)
    set(EMSC_LINKER_FLAGS_DEBUG "${EMSC_LINKER_FLAGS_DEBUG} -s STACK_OVERFLOW_CHECK=1")
endif()
if (FIPS_EMSCRIPTEN_USE_SOURCE_MAPPING)
    set(EMSC_LINKER_FLAGS_DEBUG "${EMSC_LINKER_FLAGS_DEBUG} --pre-js ${EMSCRIPTEN_ROOT_PATH}/src/emscripten-source-map.min.js")
    set(EMSC_LINKER_FLAGS_DEBUG "${EMSC_LINKER_FLAGS_DEBUG} -g4")
else()
    set(EMSC_LINKER_FLAGS_DEBUG "${EMSC_LINKER_FLAGS_DEBUG} -g")
endif()
...
if (FIPS_EMSCRIPTEN_USE_PTHREADS)
    set(EMSC_LINKER_FLAGS "${EMSC_LINKER_FLAGS} -s USE_PTHREADS=1")
endif()
...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-O0 ${EMSC_LINKER_FLAGS_DEBUG}")
